employees= ['200;Jennifer;Whalen;JWHALEN;515.123.4444;17/09/03;AD_ASST;4400;;101;10',
...
#Ecrire un script afin d'afficher la liste des employés qui ont une fonction SA_REP
#Transformer la liste en une liste de dictionnaires contenant les clés et les valeurs où les clés correspondent au nom de la colonne

#1
Sales_representative = [employee.split(';')[1] + ' ' + employee.split(';')[2] for employee in employees
        if employee.split(';')[6]=='SA_REP']

print(Sales_representative)

#2
employees_list = [{'EMPLOYEE_ID':e.split(';')[0] ,'FIRST_NAME':e.split(';')[1] ,'LAST_NAME':e.split(';')[2] ,'EMAIL':e.split(';')[3] ,'PHONE_NUMBER':e.split(';')[4] ,'HIRE_DATE':e.split(';')[5] ,'JOB_ID':e.split(';')[6] ,'SALARY':e.split(';')[7] ,'COMMISSION_PCT':e.split(';')[8] ,'MANAGER_ID':e.split(';')[9] ,'DEPARTMENT_ID':e.split(';')[10]
} for e in employees]
print(employees_list)

#3
total_salaries = [e['SALARY'] for e in employees_list]
